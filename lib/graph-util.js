...
/**
 * @param {!Object.<boolean, string>} set1
 * @param {!Object.<boolean, string>} set2
 * @return {!Object.<boolean, string>} A new set that is the intersection of the
 *     given sets.
 */
