...
var jsBuilder = require('./js-builder.js');
var kew = require('kew');
...
/** Common externs files provided for convenience. */
var EXTERNS = {
  'jquery-1.9': path.join(__dirname,
      '../3p/closure-compiler-20130823/externs/jquery-1.9.js')
};
