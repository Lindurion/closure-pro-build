...
function compileJsAsync(
  ...
  var jsCompilerArgs = [
    ...
    JS_COMPILER_PATH,
    '--compilation_level',
    isDebug ? 'SIMPLE_OPTIMIZATIONS' : 'ADVANCED_OPTIMIZATIONS',
  ...
  projectOptions.jsExterns.forEach(function(externsFile) {
    jsCompilerArgs.push('--externs');
    jsCompilerArgs.push(externsFile);
  });
